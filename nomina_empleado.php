...
echo '<div class="row">
  ...
  echo '<div class="row">
    ...
    $empleado_q = pg_query("SELECT cod_empleado,cedula,nombres,apellidos,nombre_banco,unidad_administrativa from detalle_pago where id_tipo_nomina=$id_tipo_nomina and fecha_pago='$fecha_pago' and periodo_inicio='$periodo_inicio' and periodo_final='$periodo_final' and cod_empleado=$cod_empleado group by cod_empleado,cedula,nombres,apellidos,nombre_banco,unidad_administrativa");
 ...
 echo ' <div class="row" style="padding-top: 20px; padding-bottom: 20px">
  ...
  echo '<div class="row">
    ...
    <div class="col-md-4 col-sm-4 col-xs-4">'.$empleado_r[1].'</div>
     ...
     $partida_q = pg_query("SELECT cod_partida,partida,round(monto_pago::numeric,2) as monto_pago,tipo from detalle_pago where cod_empleado=$cod_empleado and fecha_pago='$fecha_pago' and periodo_inicio='$periodo_inicio' and periodo_final='$periodo_final' and id_tipo_nomina=$id_tipo_nomina");
...
$t_asignaciones = pg_query("SELECT round(total_asignacion_pago::numeric,2) as total_asignacion_pago from total_asignaciones_pago where cod_empleado=$cod_empleado and periodo_inicio='$periodo_inicio' and periodo_final='$periodo_final' and fecha_pago='$fecha_pago' and id_tipo_nomina=$id_tipo_nomina group by  total_asignacion_pago");
...
$t_deduccion = pg_query("SELECT round(total_deduccion_pago::numeric,2) as total_deduccion_pago from total_deducciones_pago where cod_empleado=$cod_empleado and periodo_inicio='$periodo_inicio' and periodo_final='$periodo_final' and fecha_pago='$fecha_pago' and id_tipo_nomina=$id_tipo_nomina group by  total_deduccion_pago");
...
$total_neto = $sum_asignacion-$sum_deduccion;

$t_pago_neto = pg_query("SELECT round(total_neto_pago::numeric,2) as total_neto_pago from pago_final where cod_empleado=$cod_empleado and periodo_inicio='$periodo_inicio' and periodo_final='$periodo_final' and fecha_pago='$fecha_pago' and id_tipo_nomina=$id_tipo_nomina group by total_neto_pago");
