        ...
        <ul class="nav" id="side-menu" >
          ...
          <li>
            ...
            <ul class="nav nav-second-level">
              ...
              if ($_SESSION['nivel']==1) {
                echo '<li>
                <a href="#" onclick="listar_empleados()">Empleados</a>
                </li>';                  
              }
              ?>
          ...
          <li>
            <a href="#"><i class="fa fa-calendar fa-fw"></i>Permisos<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              
              <?php 
              if ($_SESSION['nivel']==1) {
                echo '<li>
                        <a href="#" onclick="permisos()">Agregar Permisos</a>
                      </li>';                  
              }
              ?>    
          ...
          <li>
            ...
            <ul class="nav nav-second-level">
              ...
              if ($_SESSION['nivel']==1) {
                echo '<li>
                        <a href="#" onclick="nomina_empleados();">N&oacutemina por empleado</a>
                      </li>';                  
              }
              ?> 
              ...
              if ($_SESSION['nivel']==1) {
                echo '<li>
                        <a href="#" onclick="nomina_partidas();">N&oacutemina por partida</a>
                      </li>';                  
              }
              ?> 
...
<footer class="main text-center">
     <strong>Sisnom 2017 &copy;</strong>Todos los derechos reservados | Diseñado por <a href="http://www.gnusistemas.com.ve">Gnusistemas</a>
</footer>
